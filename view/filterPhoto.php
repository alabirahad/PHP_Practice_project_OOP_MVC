                        ...
                        <div class="gallerButtons">
                            ...
                            <div class="col-md-3">
                                <div class="filter-photo">
                                    <button type="button" class="collapsible3"><h5>Filter Gallery <i class="fa fa-chevron-down" aria-hidden="true"></i></h5></button>
                                    <div class="contents" >
                                        <?php include('../view/searchOption.php') ?>
                                    </div>
                                    <script src="../js/filterPhoto.js"></script>
                                </div>
                            </div>
                        </div>
                    </div>
